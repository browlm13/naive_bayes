...
#df.to_csv("table_2.csv", sep='&', index=False, line_terminator='\\\\\n') write for latex

p00 = prior_a_given_b('Play', 'Yes', 'Weather', 'Sunny', df)
p01 = prior_a_given_b('Play', 'Yes', 'Temp', 'Cool', df)
p02 = prior_a_given_b('Play', 'Yes', 'Humidity', 'High', df)
p03 = prior_a_given_b('Play', 'Yes', 'Windy', 'FALSE', df)
...
p_play = (p00 * p01 * p02 * p03 * probability('Play', 'Yes', df)) / (p10 * p11 * p12 * p13)
